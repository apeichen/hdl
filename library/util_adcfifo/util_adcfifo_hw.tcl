...
proc p_util_adcfifo {} {
  ...
  add_hdl_instance ad_mem_asym ad_mem_asym
  set_instance_parameter_value ad_mem_asym DEVICE_FAMILY $m_device_family
  set_instance_parameter_value ad_mem_asym A_ADDRESS_WIDTH 0
  set_instance_parameter_value ad_mem_asym A_DATA_WIDTH $m_adc_data_width
  set_instance_parameter_value ad_mem_asym B_ADDRESS_WIDTH $m_dma_addr_width
  set_instance_parameter_value ad_mem_asym B_DATA_WIDTH $m_dma_data_width
